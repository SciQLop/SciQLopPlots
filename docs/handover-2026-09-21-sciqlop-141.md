...
| Tests | `tests/integration`: 1094 passed, exit 0 (run recipe below) |
...
| Item | Where | Notes |
|---|---|---|
| Colour-by-scalar for `SciQLopLineGraph` (#141 item 7) | SciQLopPlots + **NeoQCP** | See "Decision pending". |
